...
<p>
	...
	<br>
	<?php _e('If you rather want to use the new <b>picture</b> element or the <b>srcset</b> method (<a href="http://scottjehl.github.io/picturefill/">Picturefill 2.1.0</a>), simply select it below.') ?>
</p>
<div class="input-group">
	...
	<label>
		<?php _e('srcset'); ?>
		<input name="selected_element" type="radio" value="srcset" <?php echo ( $selected_element == 'srcset' ) ? 'checked="checked"' : ''; ?>>
	</label>
</div>
